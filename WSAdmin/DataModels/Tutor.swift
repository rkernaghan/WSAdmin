...
//	var tutorAvailability: String			// Tutor availability data from Tutor's Timesheet
	...
	var tutorTotalCost: Float			// The sum of the total cost of this Tutor's services (paid to Tutor)  Tutor started (or system initiated)
	var tutorTotalRevenue: Float			// The sum of the total revenue for this Tutor since Tutor started (or system initiated)
	var tutorTotalProfit: Float			// The total profit generated by the Tutor since Tutor started (or system initiated)
