...
// The data and functions associated with a Tutor object.
...
//	var tutorAvailability: String			// Tutor availability data from Tutor's Timesheet
	...
	var tutorMaxStudents: Int			// Maximum number of Students the Tutor would like assigned at one time (informational)
	var tutorStudentCount: Int			// The number of Students currently assigned to the Tutor
	var tutorServiceCount: Int			// The number of Services currently assigned to the Tutor
	var tutorTotalSessions: Int			// A count of the total number of sessions the Tutor has conducted
	var tutorTotalCost: Double			// The sum of the total cost of this Tutor's services (paid to Tutor)  Tutor started (or system initiated)
	var tutorTotalRevenue: Double			// The sum of the total revenue for this Tutor since Tutor started (or system initiated)
	var tutorTotalProfit: Double			// The total profit generated by the Tutor since Tutor started (or system initiated)
	var tutorDetailsLoaded: Bool			// Have the Tutor's Student and Services list been loaded
	var tutorStudents = [TutorStudent]()		// An array of the Students assigned to the Tutor
	var tutorServices = [TutorService]()		// An array of the Services assigned to the Tutor
...
//		self.tutorAvailability = " "
	...
	// --------------------------------------------------------------------------------------------
	//
	//					Tutor Data Counts functions
	//
	
	// This function reads in the Tutor's Student and Service counts from the TutorDetails sheet for the Tutor and returns the counts and the Tutor's Timesheet FileID
	func fetchTutorDataCounts(tutorName: String) async -> (Int, Int, String){
		...
		do {
			...
			if let sheetData = sheetData {
				...
				logMessage = "ERROR: could not read Tutor Data Counts for Tutor \(tutorName)"
				print(logMessage)
	...
	// This function updates the Student and Service counts for a Tutor in the TutorDetails sheet
	...
	// This function fetches the Students assigned to a Tutor from the TutorDetails sheet for the Tutor and calls loadTutorStudentRows to add them to the Tutor object
	//
	...
	// This function adds a TutorStudent object to a Tutor
	...
	// This function updates the attributes of a Tutor's assigned Service and returns a completion flag
	func updateTutorService(tutorServiceNum: Int, timesheetName: String, invoiceName: String, billingType: BillingTypeOption, cost1: Double, cost2: Double, cost3: Double, price1: Double, price2: Double, price3: Double) async -> Bool {
		var completionFlag: Bool = true
	...
	// This function adds a TutorService object to a Tutor
