...
struct PgmConstants {
	...
	static let studentContactAddress1Position = 6
	static let studentContactAddress2Position = 7
	static let studentContactCityPosition = 8
	static let studentContactStatePosition = 9
	static let studentContactZipCodePosition = 10
	static let studentStartDatePosition = 11
	static let studentAssignedUnassignedDatePosition = 12
